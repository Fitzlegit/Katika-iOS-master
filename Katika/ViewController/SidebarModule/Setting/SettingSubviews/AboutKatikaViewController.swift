//
//  AboutKatikaViewController.swift
//  Katika
//
...
class AboutKatikaViewController: UIViewController {
...
extension AboutKatikaViewController : UIWebViewDelegate{
...
extension AboutKatikaViewController : WebServiceHelperDelegate{
...
//            txtView.text = (dict_SettingData["aboutapp"] as! NSString) as String!
            ...
            web_Main.loadRequest(URLRequest(url: NSURL(string : dict_SettingData["about-ios"] as! String) as! URL))
        }
    }
