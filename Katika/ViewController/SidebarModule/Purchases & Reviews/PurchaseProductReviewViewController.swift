//
//  PurchaseProductReviewViewController.swift
//  Katika
//
...
class PurchaseProductReviewViewController: UIViewController {
    ...
    //MARK: - Other Files -
    func commanMethod(){
        lbl_ProductName.text = objGet.str_Title as String
        vw_Rate.rating = 0
//        
...
//        }
    ...
    func Post_Review(){
        ...
        //Declaration URL
        let strURL = "\(Constant.BaseURL)add_shop_review"
        
        //Pass data in dictionary
        var jsonData : NSMutableDictionary =  NSMutableDictionary()
        jsonData = [
            "user_id" : objUser?.str_Userid as! String,
            "shop_id" : objGet.str_Shop_id as String,
            "product_id" : objGet.str_Product_id as String,
            "rate" : String(vw_Rate.rating),
            "description" : tv_Description.text,
            "order_id" : objGet.str_ID as String,
        ]
//
...
extension PurchaseProductReviewViewController : WebServiceHelperDelegate{
