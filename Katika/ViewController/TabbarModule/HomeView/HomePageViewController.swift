...
class HomePageViewController: UIPageViewController {
    ...
    fileprivate(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [self.newColoredViewController("Featured"),
                self.newColoredViewController("Latest"),
                self.newColoredViewController("Recommended"),
                self.newColoredViewController("RecentlyViewed")]
    }()
