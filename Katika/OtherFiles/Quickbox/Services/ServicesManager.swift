...
//        QMMessageNotificationManager.showNotification(withTitle: dialogName, subtitle: message.text, type: QMMessageNotificationType.info)
        messageBar.MessageShow(title:message.text as! NSString, alertType: MessageView.Layout.CardView, alertTheme: .info, TopBottom: true)
    }
    ...
    override func handleErrorResponse(_ response: QBResponse) {
        ...
        messageBar.MessageShow(title:errorMessage as NSString, alertType: MessageView.Layout.CardView, alertTheme: .error, TopBottom: true)
